...
export function EdgeUpgradePanel({ selectedEdge, onClose }: EdgeUpgradePanelProps) {
  ...
  const handleUpgrade = () => {
    ...
    if (spendModules(nextUpgrade.cost)) {
      ...
      alert(`Not enough modules! Need ${nextUpgrade.cost}, have ${economy.modules.toFixed(1)}`);
    }
  };
        ...
        {nextUpgrade ? (
          <div className="pt-2 border-t">
            ...
            <Button
              ...
              disabled={economy.modules < nextUpgrade.cost}
              className="w-full"
            >
